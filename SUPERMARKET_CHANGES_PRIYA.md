...
2.) Updated updateQuality() method under SuperMarketPlusPlus.java class for Örganic Banana" changes. It is better to have a switch case on the ItemNames enum and modularize the updateQuality() method. Too many if/else statements in this method.
